...
# ext returns the extant of the layer 
ext(spr_prec)

## crop function, direct entry of lat/long
...
## compare extant between spr_nw and spr_n
ext(spr_nw)
ext(spr_n)
...
#1
spr_tmp1 <- rast(here("data/spr_tmp_ncnw.tif"))
spr_tmp2 <- rast(here("data/spr_tmp_ncne.tif"))
spr_tmp3 <- rast(here("data/spr_tmp_ncsw.tif"))
spr_tmp4 <- rast(here("data/spr_tmp_ncse.tif"))

list_nc <- list(spr_tmp1,
                spr_tmp2,
                spr_tmp3,
                spr_tmp4)
spr_nc <- sprc(list_nc)
spr_merge <- merge(spr_nc)
